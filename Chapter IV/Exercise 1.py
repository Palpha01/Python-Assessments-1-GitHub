...
heading = Label(bio,text="Bio.txt",font=('Helvetica',20,'bold')).grid(row=0,column=1,padx=10,pady=5)

name = Label(bio,text="Name:").grid(row=1,column=0,padx=5)
name_entry = Entry(bio,width=30).grid(row=1,column=1)

age = Label(bio,text="Age:").grid(row=2,column=0,padx=5)
age_entry = Entry(bio,width=30).grid(row=2,column=1)

hometown = Label(bio,text="Hometown:").grid(row=3,column=0,padx=5)
